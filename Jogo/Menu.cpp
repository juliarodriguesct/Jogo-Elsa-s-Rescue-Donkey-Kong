...
int mov_barril(SDL_Rect BarrilRect)
{
    ...
    if(BarrilRect.y == 250)
        mb = 2;
    if(BarrilRect.y >= 250 && BarrilRect.x == 120)
        mb = 3;
    if(BarrilRect.y == 350 && BarrilRect.x >= 10)
        mb = 1;
    if(BarrilRect.y >= 350 && BarrilRect.x == 650)
        mb = 3;
    if(BarrilRect.y == 450 && BarrilRect.x <= 700)
        mb = 2;
    if(BarrilRect.y == 450 && BarrilRect.x == 120)
        mb = 3;
...
//função que controla as plataformas
int controlaplataforma(SDL_Rect *Sprite, SDL_Rect *Barril)
{
    int ctr_plat = 0;

    if(Sprite->y  ==  520 && Barril->y == 550)
        ctr_plat = 1;
    else if(Sprite->y  == 420 && Barril->y == 450)
        ctr_plat = 1;
    else if(Sprite->y  == 317 && Barril->y == 350)
        ctr_plat = 1;
    else if(Sprite->y  == 220 && Barril->y == 250)
        ctr_plat = 1;
    else if(Sprite->y  == 117 && Barril->y == 150)
        ctr_plat = 1;
    else if(Sprite->x >= 410 && Sprite->x <= 420 && Sprite->y <= 520 && Sprite->y >= 420 && Barril->x >= 410 && Barril->x <= 420 && Barril->y <= 520 && Barril->y >= 420)
        ctr_plat = 1;
    else if(Sprite->x >= 610 && Sprite->x <= 620 && Sprite->y <= 420 && Sprite->y >= 317 && Barril->x >= 610 && Barril->x <= 620 && Barril->y <= 420 && Barril->y >= 317)
        ctr_plat = 1;
    else if(Sprite->x >= 140 && Sprite->x <= 150 && Sprite->y <= 317 && Sprite->y >= 220 && Barril->x >= 140 && Barril->x <= 150 && Barril->y <= 317 && Barril->y >= 220)
        ctr_plat = 1;
    else if(Sprite->x >= 515 && Sprite->x <= 530 && Sprite->y <= 220 && Sprite->y >= 117 && Barril->x >= 515 && Barril->x <= 530 && Barril->y <= 220 && Barril->y >= 117)
        ctr_plat = 1;
    else if(Sprite->x >= 270 && Sprite->x <= 280 && Sprite->y <= 117 && Sprite->y >= 20 && Barril->x >= 270 && Barril->x <= 280 && Barril->y <= 117 && Barril->y >= 20)
        ctr_plat = 1;
    else
        ctr_plat = 0;
...
//cria as variaveis da colisao do barril
int c_b1 = 0, c_b2 = 0, c_b3 = 0, c_b4 = 0, c_b5 = 0, c_b6 = 0, c_b7 = 0;
...
//cria o controle das plataformas
int control_plat1 = 0, control_plat2 = 0, control_plat3 = 0, control_plat4 = 0, control_plat5 = 0, control_plat6 = 0, control_plat7 = 0;

//cria as variaveis do fim do jogo
int gameover = 0, morte = 0, tmorte = 0;
...
int colidiu_o1 = 0, colidiu_o2 = 0, colidiu_o3 = 0, colidiu_o4 = 0, colidiu_o5 = 0;
int olafull = 0, time_olaf = 0;
...
//cria as variaveis do tempo
Uint32 Gtime1, Gtime2, Gtime3;
char CharTimeM[3], CharTimeS[3];
...
int main( int argc, char* args[] )
{
   ...
   SDL_Surface *tela = NULL;
    ...
    SDL_Surface *game_time1 = NULL;
    SDL_Surface *game_time2 = NULL;
    SDL_Surface *game_time3 = NULL;
    SDL_Surface *game_time4 = NULL;
    SDL_Surface *fullolaf = NULL;
    ...
    else
    {
        ...
        if( tela != NULL )
        {
            ...
            sprite = IMG_Load("movimentos.png" );
           ...
           //cria os rects do sprite
            ...
            //Diminui o volume do som de ganhar ponto
            Mix_Volume(5, 30);
            ...
            while( quit != 0)
            {
                ...
                while( SDL_PollEvent( &e ) != 0)
                {
                    ...
                    if (c == 2)
                    {
                        ...
                        // permite que suba
                        if (subir == 1 && invencibilidade == 0 && tmorte==0)
                        {
                       ...
                       if(pulocima == 1){
                        ...
                        //pontuacao do olaf
                        if(colisao(&SpriteRect, &olaf1Rect) == 1 && colidiu_o1 == 0 && SpriteRect.y==520)
                        {
                            p1=0;
                            colidiu_o1 = 1;
                            olafull++;
                        ...
                        if(colisao(&SpriteRect, &olaf2Rect) == 1 && colidiu_o2 == 0 && SpriteRect.y==420)
                       {
                            p2=0;
                            colidiu_o2 = 1;
                            olafull++;
                        ...
                        if(colisao(&SpriteRect, &olaf3Rect) == 1 && colidiu_o3 == 0 && SpriteRect.y==420)
                        {
                            p3=0;
                            colidiu_o3 = 1;
                            olafull++;
                        ...
                        if(colisao(&SpriteRect, &olaf4Rect) == 1 && colidiu_o4 == 0 && SpriteRect.y==317)
                        {
                            p4=0;
                            colidiu_o4 = 1;
                            olafull++;
                        ...
                        if(colisao(&SpriteRect, &olaf5Rect) == 1 && colidiu_o5 == 0 && SpriteRect.y==220)
                        {
                            p5=0;
                            colidiu_o5 = 1;
                            olafull++;
                        ...
                        if(olafull == 5 && time_olaf != 1100)
                        {
                            time_olaf++;
                            SDL_BlitSurface( fullolaf, &ofullimg, tela, &OfullRect);
                            ...
                            if(colisao(&OfullRect, &BRect) == 1)
                            {
                                aux_poder = 1;
                                c_b1 = 1;
                            }
                            if(colisao(&OfullRect, &BRect2) == 1)
                            {
                                aux_poder2 = 1;
                                c_b2 = 1;
                            }
                            if(colisao(&OfullRect, &BRect3) == 1)
                            {
                                aux_poder3 = 1;
                                c_b3 = 1;
                            }
                            if(colisao(&OfullRect, &BRect4) == 1)
                            {
                                aux_poder4 = 1;
                                c_b4 = 1;
                            }
                            if(colisao(&OfullRect, &BRect5) == 1)
                            {
                                aux_poder5 = 1;
                                c_b5 = 1;
                            }
                            if(colisao(&OfullRect, &BRect6) == 1)
                            {
                                aux_poder6 = 1;
                                c_b6 = 1;
                            }
                            if(colisao(&OfullRect, &BRect7) == 1)
                            {
                                aux_poder7 = 1;
                                c_b7 = 1;
                            }
                        ...
                        if (b1 == 1 && aux_poder != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg1, tela, &BRect );
                        if (b2 == 1 && aux_poder2 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg2, tela, &BRect2 );
                        if (b3 == 1 && aux_poder3 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg3, tela, &BRect3 );
                        if (b4 == 1 && aux_poder4 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg4, tela, &BRect4 );
                        if (b5 == 1 && aux_poder5 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg5, tela, &BRect5 );
                        if (b6 == 1 && aux_poder6 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg6, tela, &BRect6 );
                        if (b7 == 1 && aux_poder7 != 1)
                            SDL_BlitSurface( bola_de_neve, &bnimg7, tela, &BRect7 );
                    ...
                    //faz com que o tempo apareça na tela
                    game_time1 = TTF_RenderText_Solid( fonte, "Time:", { 150, 188, 224 } );
                    SDL_BlitSurface(game_time1 , NULL, tela, &GTeRect );

                    game_time4 = TTF_RenderText_Solid( fonte, ":", { 150, 188, 224 } );
                    SDL_BlitSurface(game_time4 , NULL, tela, &GTpRect );

                    sprintf(CharTimeM, "%d" , (Gtime2 - Gtime1)/60000);
                    game_time3 = TTF_RenderText_Solid( fonte, CharTimeM, { 150, 188, 224 } );
                    SDL_BlitSurface(game_time3 , NULL, tela, &GTmRect );

                    Gtime3 = (Gtime2 - Gtime1)/60000;

                    if((Gtime2 - Gtime1)%60000/1000 < 10)
                        sprintf(CharTimeS, "0%d" , (Gtime2 - Gtime1)%60000/1000);
                    else
                        sprintf(CharTimeS, "%d" , (Gtime2 - Gtime1)%60000/1000);
                    game_time2 = TTF_RenderText_Solid( fonte, CharTimeS, { 150, 188, 224 } );
                    SDL_BlitSurface(game_time2 , NULL, tela, &GTsRect );
                    ...
                    //faz o controle da perca de vida
                    control_plat1 = controlaplataforma(&SpriteRect, &BRect);
                    control_plat2 = controlaplataforma(&SpriteRect, &BRect2);
                    control_plat3 = controlaplataforma(&SpriteRect, &BRect3);
                    control_plat4 = controlaplataforma(&SpriteRect, &BRect4);
                    control_plat5 = controlaplataforma(&SpriteRect, &BRect5);
                    control_plat6 = controlaplataforma(&SpriteRect, &BRect6);
                    control_plat7 = controlaplataforma(&SpriteRect, &BRect7);

                    //faz perder uma vida
                    if(invencibilidade == 0)
                    {
                        if(colisao(&SpriteRect,&BRect) == 1 && c_b1 == 0 &&  control_plat1 == 1)
                        {
                            menosvida = 1;
                            c_b1 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect2) == 1 && c_b2 == 0 &&  control_plat2 == 1)
                        {
                            menosvida = 1;
                            c_b2 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect3) == 1 && c_b3 == 0 &&  control_plat3 == 1)
                        {
                            menosvida = 1;
                            c_b3 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect4) == 1 && c_b4 == 0 &&  control_plat4 == 1)
                        {
                            menosvida = 1;
                            c_b4 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect5) == 1 && c_b5 == 0 &&  control_plat5 == 1)
                        {
                            menosvida = 1;
                            c_b5 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect6) == 1 && c_b6 == 0 &&  control_plat6 == 1)
                        {
                            menosvida = 1;
                            c_b6 = 1;
                        }
                        if(colisao(&SpriteRect,&BRect7) == 1 && c_b7 == 0 &&  control_plat7 == 1)
                        {
                            menosvida = 1;
                            c_b7 = 1;
                        }
                    ...
                    if(gameover == 1)
                    {
                        ...
                        if((Aux_P == 340 || Aux_P == 680 || Aux_P == 40 || Aux_P == 110 || Aux_P == 510 || Aux_P == 70 || Aux_P == 230 || Aux_P == 220 || Aux_P == 480) && jump == 0 && tmorte == 0)
                        {
                            Pontuacao += 50;
                            Aux_P = 0;
                            Mix_PlayChannel(5, m_jpoint, 0);
                        ...
                        if( (colisao(&SpriteRect,&HammerRect) == 1 &&  SpriteRect.y == 520 ) || (colisao(&SpriteRect,&HammerRect2) == 1 &&  SpriteRect.y == 220 ))
                        {
                            e_hammer++;
                            if(e_hammer == 1)
                            {
                        ...
                        {
                            tempo_pd1++;
                            if(colisao(&SpriteRect,&BRect) == 1 && c_b1 == 0)
                            {
                                if(aux_poder != 1)
                                    Pontuacao += 25;
                                aux_poder = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect2) == 1 && c_b2 == 0)
                            {
                                if(aux_poder2 != 1)
                                    Pontuacao += 25;
                                aux_poder2 = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect3) == 1 && c_b3 == 0)
                            {
                                if(aux_poder3 != 1)
                                    Pontuacao += 25;
                                aux_poder3 = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect4) == 1 && c_b4 == 0)
                            {
                                if(aux_poder4 != 1)
                                    Pontuacao += 25;
                                aux_poder4 = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect5) == 1 && c_b5 == 0)
                            {
                                if(aux_poder5 != 1)
                                    Pontuacao += 25;
                                aux_poder5 = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect6) == 1 && c_b6 == 0)
                            {
                                if(aux_poder6 != 1)
                                    Pontuacao += 25;
                                aux_poder6 = 1;
                            ...
                            if(colisao(&SpriteRect,&BRect7) == 1 && c_b7 == 0)
                            {
                                if(aux_poder7 != 1)
                                    Pontuacao += 25;
                                aux_poder7 = 1;
                        ...
                        if(BRect.x == 150 && BRect.y == 150 && aux_poder == 1)
                        {
                            aux_poder = 0;
                            e_poder1 = 0;
                            c_b1 = 0;
                        }
                        if(BRect2.x == 150 && BRect2.y == 150 && aux_poder2 == 1)
                        {
                            aux_poder2 = 0;
                            e_poder2 = 0;
                            c_b2 = 0;
                        }
                        if(BRect3.x == 150 && BRect3.y == 150 && aux_poder3 == 1)
                        {
                            aux_poder3 = 0;
                            e_poder3= 0;
                            c_b3 = 0;
                        }
                        if(BRect4.x == 150 && BRect4.y == 150 && aux_poder4 == 1)
                        {
                            aux_poder4 = 0;
                            e_poder4 = 0;
                            c_b4 = 0;
                        }
                        if(BRect5.x == 150 && BRect5.y == 150 && aux_poder5 == 1)
                        {
                            aux_poder5 = 0;
                            e_poder5 = 0;
                            c_b5 = 0;
                        }
                        if(BRect6.x == 150 && BRect6.y == 150 && aux_poder6 == 1)
                        {
                            aux_poder6 = 0;
                            e_poder6 = 0;
                            c_b6 = 0;
                        }
                        if(BRect7.x == 150 && BRect7.y == 150 && aux_poder7 == 1)
                        {
                            aux_poder7 = 0;
                            e_poder7 = 0;
                            c_b7 = 0;
