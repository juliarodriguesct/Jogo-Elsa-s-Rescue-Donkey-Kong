            ...
            while( quit != 0)
            {
                ...
                if(be == -1)
                {
                   ...
                   if (annaRect.y==210 && (SpriteRect.y==520 || SpriteRect.y==420 || SpriteRect.y==317 || SpriteRect.y==220 || SpriteRect.y==117 || SpriteRect.y==20))
                    ...
                    //movimentos do vilao
                    if((BRect.y==150 && BRect.x>150 && BRect.x<180) ||
                       (BRect2.y==150 && BRect2.x>150 && BRect2.x<180) ||
                       (BRect3.y==150 && BRect3.x>150 && BRect3.x<180) ||
                       (BRect4.y==150 && BRect4.x>150 && BRect4.x<180) ||
                       (BRect5.y==150 && BRect5.x>150 && BRect5.x<180) ||
                       (BRect6.y==150 && BRect6.x>150 && BRect6.x<180) ||
